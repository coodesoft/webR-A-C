...
return array(
    ...
    'You registered from {site_name}' => 'Te has registrado en {site_name}. Confirma tu cuenta.',
    'Please activate you account go to {activation_url}' => 'Por favor, activa tu cuenta haciendo click en el siguiente enlace:\n {activation_url}',
    ...
    'Retype Password is incorrect.' => 'La contraseña es incorrecta.',
    ...
    'Thank you for your registration. Please check your email or login.' => "Gracias por registrarse. Por favor revise su email.",
    ...
    'Thank you for your registration. Contact Admin to activate your account.' =>  'Gracias por registrarse. Contactar con el Administrador para activar su cuenta.',
    'Restore' => 'Restaurar',
    'Please enter your login or email addres.' => "Por favor escriba su nombre de usuario o dirección de email.",
    'Incorrect recovery link.' => 'Link de recuperación incorrecto.',
    ...
    'Active' => 'Activo',
    'Banned' => 'Banned',
    'Please fill out the following form with your login credentials:' => "Por favor complete el siguiente formulario con sus datos de inicio de sesión:",
