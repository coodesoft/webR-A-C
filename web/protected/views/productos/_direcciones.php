...
if (count($direcciones) != 0) {
    ...
    <div class="col-sm-6">
        <p>
          <strong>
            <span class="facturacion_identificacion"><?= $direcciones[0]->identificacion; ?></span>
          </strong>
        </p>
        <p>
          <span class="facturacion_fullname"><?= $direcciones[0]->fullName; ?></span>
        </p>
        <p>
          <span class="facturacion_domicilio"><?= $direcciones[0]->fullDomicilio; ?></span>
        </p>
        <p>
          <span class="facturacion_ciudad"><?= $direcciones[0]->ciudad->ciudad; ?></span>
        </p>
        <p>
          <span class="facturacion_provincia"><?= $direcciones[0]->provincia->provincia; ?></span>, <span class="facturacion_postal"><?= $direcciones[0]->cpostal; ?></span>
        </p>
        <input type="hidden" value="<?= $direcciones[0]->cliente_direccion_id ?>" class="facturacion_id" name="facturacion_id" />
    </div>
    <div class="col-sm-6">
